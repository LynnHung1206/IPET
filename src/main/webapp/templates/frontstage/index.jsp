					...
					<div class="row">
						...
						<div class="col-lg-6 col-md-6 col-sm-5 col-12">
							<div class="slider-single-img slider-animated-1">
								<img class="animated"
									src="${pageContext.request.contextPath}/static/frontstage/img/slider/slider-single-img-2.png"
									alt="">
							</div>
						</div>
					</div>
					...
					<div class="single-food-category cate-padding-1 text-center mb-30">
						<a href="${pageContext.request.contextPath}/ipet-front/shop/home">
							<div class="single-food-hover-2">
								<img
									src="${pageContext.request.contextPath}/static/frontstage/img/product/shop.jpg"
									alt="">
							</div>
				...
				<div class="col-lg-4 col-md-4">
					<div class="single-food-category cate-padding-2 text-center mb-30">
						<a href="<c:url value='/ipet-front/salon/salonCategory' />">
							<div class="single-food-hover-2">
								<img
									src="${pageContext.request.contextPath}/static/frontstage/img/product/salon.jpg"
									alt="">
							</div>
							<div class="single-food-content">
								<h3>寵物美容</h3>
