	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<h3>新增房間</h3>
					<form action="${pageContext.request.contextPath}/ipet-back/hotel/addRoom"
						method="post" >
						<table id="roomdata">
								<tr>
									<td>房型</td>
								...
								<tr>
									...
									<td><select name="roomCheckStatus">
											<option value="0" ${room.getroomCheckStatus() == 0 ?'selected':''}>空房</option>
											<option value="1" ${room.getroomCheckStatus() == 1 ?'selected':''}>已預約</option>
											<option value="2" ${room.getroomCheckStatus() == 2 ?'selected':''}>已入住</option>
									</select></td>
								</tr>
								<tr>
									<td>上下架狀態</td>
									<td><select name="roomSaleStatus">
											<option value="0" ${room.getroomCheckStatus() == 0 ?'selected':''}>上架</option>
											<option value="1" ${room.getroomCheckStatus() == 1 ?'selected':''}>下架</option>
									</select></td>
								</tr>
								<tr>
